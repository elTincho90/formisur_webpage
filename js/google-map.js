...
=============================================== */
	...
	$(document).ready(function() {
			...
			var latlng = new google.maps.LatLng(-34.816582, -56.312868);
			var latlng2 = new google.maps.LatLng(-34.881615, -56.188436);
			...
			var map2 = new google.maps.Map(document.getElementById('google-map2'), myOptions2);
			...
			var myLatlng = new google.maps.LatLng(-34.816582, -56.312868);
			...
			var infowindow = new google.maps.InfoWindow({
			 ...
			 var myLatlngSecond = new google.maps.LatLng(-34.881615, -56.188436);
			 ...
			 google.maps.event.addListener(markerSecond, 'click', function() {
				infowindowSecond.open(map2,markerSecond);
			  });
